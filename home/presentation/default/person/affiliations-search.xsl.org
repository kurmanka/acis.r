<xsl:stylesheet
  ...
  <xsl:template name='search-form'>
    ...
    <acis:form screen='@affiliations/search' xsl:use-attribute-sets='form' class='narrow' name='searchform'>
      ...
      <table id='controls'>
        <tr>
          <td>
            <xsl:call-template name='fieldset'>
              <xsl:with-param name='content'>
                ...
                <acis:input name='search-what' id="what" value='{$search-what}' size='35'>
                  <acis:check nonempty=''/>
            ...
            <xsl:call-template name='fieldset'>
              <xsl:with-param name='content'>
                ...
                <!-- this code allows seaching by name and institution -->
                <!-- 
          ...
          <td style='vertical-align: top; padding-top: .6em;'>
            <span id='show-instructions-trigger' style='display: none;'>
              <small>[<a href='javascript:show_instructions();search_focus();' class='int'>
...
ft-count < 10    => show fulltext and loose matches
    ...
    <div id='search-results'>
      ...
      <xsl:variable name='show-loose'  select='$loose-count and ( $loose-mode or ( $exact-count = 0 and $ft-count &lt; 10 ) )'/>
      ...
      <xsl:variable name='loose-mode-form'>
        ...
        <acis:form>
          <div>
            <input type='hidden' name='search-what' value='{$search-what}'/>
      ...
      <xsl:if test='$ft-count'>
        ...
        <xsl:if test='not($show)'>
          <p style='display: none' id='ft-matches-trigger'>
            We also found some near matches, which are hidden.  
            <a href='javascript:show("ft-matches");hide("ft-matches-trigger");'
               class='int'>Wish to see? (<xsl:value-of select='$ft-count'/>
