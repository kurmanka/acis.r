    ...
    <xsl:call-template name='new-user-page'>
      ...
      <xsl:with-param name='content'>
        ...
        <xsl:choose>
          ...
          <h2>We have just sent you a confirmation email</h2>
          
          <p>The address we sent it to: 
          <strong><xsl:value-of select='$user-login'/></strong></p>
        
          <p>Please check your mailbox and follow the instructions in the
          ...
          <p>Below is all the main information of your profile.  You might want
          to review it.</p>
