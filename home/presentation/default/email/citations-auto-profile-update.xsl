...
<xsl:stylesheet
  ...
  <xsl:variable name='added-by-doc' 
                select='//add-by-doc/list-item'/>

  <xsl:variable name='added-by-doc-count' 
                select='count(//add-by-doc/list-item)'/>

  <xsl:variable name='added-by-name' 
                select='//add-by-name/list-item'/>

  <xsl:variable name='added-by-name-count' 
                select='count(//add-by-name/list-item)'/>
